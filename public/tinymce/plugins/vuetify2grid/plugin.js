 ...
 */
 ...
 (function () {
  tinymce.PluginManager.add('vuetify2grid', vuetify2gridPlugin);

  function vuetify2gridPlugin(editor, url) {
    editor.contentCSS.push(url + '/vuetifygrid-style.css');

    editor.ui.registry.addToggleButton('vuetify2grid', {
      text: 'VF2 Grid',
      tooltip: 'Vuetify2 Grid System',
      onAction: Tinymce_vf2_grid,
    ...
    function Tinymce_vf2_grid() {
      var dialogueTitle = 'Insert Vuetify2 Grids';
      ...
      if (editMode) {
        ...
        dialogueTitle = 'Update/Remove Vuetify2 Grids';
      }
      ...
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          ...
          if(data.cont_class){
              cont_class = data.cont_class;
          }

          var containerDiv = '<div class="sci-bg ' + cont_class +'"><div  class="' + data.container + '" >'
          ...
          if (editMode) {
            ...
            editor.insertContent(leadingHtml + containerDiv + '<div class="row">' + htmlContents + '</div></div></div><br/>' + endingHtml);
          }
          e.close();
        }
      });
